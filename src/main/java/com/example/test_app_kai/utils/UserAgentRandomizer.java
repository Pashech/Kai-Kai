...
public class UserAgentRandomizer {
    ...
    private static final List<String> userAgents = Arrays.asList("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/134.0.0.0 Safari/537.36",
    ...
    public static String getRandomUserAgent() {
        ...
        log.info("Generated User-Agent: {}", userAgent);
        return userAgent;
    }
}
